...
WebUI.click(findTestObject('Object Repository/General Settings/SR GS001-Verify Where to Include Author Reviews/Page_Dashboard  Starcat Testing  WordPress/div_Posts'))

WebUI.mouseOver(findTestObject('Object Repository/General Settings/SR GS001-Verify Where to Include Author Reviews/Page_Posts  Starcat Testing  WordPress/a_Movie Review'))

WebUI.click(findTestObject('General Settings/SR GS001-Verify Where to Include Author Reviews/Page_Posts  Starcat Testing  WordPress/View Post'))

WebUI.verifyElementPresent(findTestObject('General Settings/SR GS001-Verify Where to Include Author Reviews/Page_Movie Review  Starcat Testing/Author Rating'), 
    0)
...
WebUI.click(findTestObject('Object Repository/General Settings/SR GS001-Verify Where to Include Author Reviews/Page_Starcat Settings  Starcat Testing  WordPress/div_Posts'))

WebUI.mouseOver(findTestObject('Object Repository/General Settings/SR GS001-Verify Where to Include Author Reviews/Page_Posts  Starcat Testing  WordPress/a_Movie Review'))

WebUI.click(findTestObject('General Settings/SR GS001-Verify Where to Include Author Reviews/Page_Posts  Starcat Testing  WordPress/View Post'))

WebUI.verifyElementNotPresent(findTestObject('General Settings/SR GS001-Verify Where to Include Author Reviews/Page_Movie Review  Starcat Testing/Author Rating'), 
    0)
...
WebUI.click(findTestObject('Object Repository/General Settings/SR GS001-Verify Where to Include Author Reviews/Page_Starcat Settings  Starcat Testing  WordPress/div_Pages'))

WebUI.mouseOver(findTestObject('Object Repository/General Settings/SR GS001-Verify Where to Include Author Reviews/Page_Pages  Starcat Testing  WordPress/a_Movie page'))

WebUI.click(findTestObject('General Settings/SR GS001-Verify Where to Include Author Reviews/Page_Posts  Starcat Testing  WordPress/View Page'))
