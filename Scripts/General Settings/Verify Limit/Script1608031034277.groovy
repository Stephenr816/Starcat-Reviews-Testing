...
WebUI.verifyElementText(findTestObject('Object Repository/General Settings/Verify Limit/Page_Movie Review  Starcat Testing/div_4.5'), 
    '4.5')
...
WebUI.verifyElementText(findTestObject('Object Repository/General Settings/Verify Limit/Page_Movie Review  Starcat Testing/div_9'), 
    '9')
