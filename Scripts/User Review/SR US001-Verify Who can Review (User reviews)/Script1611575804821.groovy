...
WebUI.setEncryptedText(findTestObject('Object Repository/User reviews/Verify Who can Review(User reviews)/Page_Log In  Starcat Testing  WordPress/input_Password_pwd'), 
...
WebUI.click(findTestObject('Object Repository/User reviews/Verify Who can Review(User reviews)/Page_Dashboard  Starcat Testing  WordPress/div_Starcat Settings'))

WebUI.click(findTestObject('Object Repository/User reviews/Verify Who can Review(User reviews)/Page_Starcat Settings  Starcat Testing  WordPress/a_User Reviews'))

WebUI.selectOptionByValue(findTestObject('Object Repository/User reviews/Verify Who can Review(User reviews)/Page_Starcat Settings  Starcat Testing  WordPress/select_Logged In UsersEveryone'), 
    'logged_in', true)

WebUI.click(findTestObject('Object Repository/User reviews/Verify Who can Review(User reviews)/Page_Starcat Settings  Starcat Testing  WordPress/input_You have unsaved changes, save your c_a04d4d'))
...
WebUI.verifyElementNotVisible(findTestObject('Object Repository/User reviews/Verify Who can Review(User reviews)/Page_Movie Review  Starcat Testing/textarea_criteria 2_description'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementNotVisible(findTestObject('Object Repository/User reviews/Verify Who can Review(User reviews)/Page_Movie Review  Starcat Testing/div_Submit'), 
    FailureHandling.STOP_ON_FAILURE)
